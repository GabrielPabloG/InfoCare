...
try {
    ...
    $sqlTel = "SELECT numero FROM telefone WHERE entidade_tipo = 'funcionario' AND entidade_id = ? LIMIT 1";
...
<html>
    ...
    <body class="fundo" id="fundoCadastro">    
        ...
        <div class="box" style="margin-top: 1em;">
            <form action="../Controller/rotinasAtualizarFuncionario.php" method="post" class="container">
