       ...
       ?>
        ...
        <form action="../Controller/rotinasAtualizar.php" method="post">
            ...
            $conexao = abrirConexao();
                ...
                $dados = "SELECT tbFuncionario.nomeFuncionario, 
				tbFuncionario.cpfFuncionario, 
				tbFuncionario.sexoFuncionario, 
				tbFuncionario.NascFuncionario, 
				tbFuncionario.salarioFuncionario, 
				tbFuncionario.emailFuncionario, 
				tbFuncionario.senhaFuncionario, 
				tbEnderecoFuncionario.ruaEnderecoFuncionario, 
				tbEnderecoFuncionario.bairroEnderecoFuncionario, 
				tbEnderecoFuncionario.cepEnderecoFuncionario, 
				tbEnderecoFuncionario.numCasaFuncionario,
				tbTelefoneFuncionario.numeroTelefoneFuncionario
				FROM tbFuncionario 
				INNER JOIN tbEnderecoFuncionario 
				ON tbFuncionario.codEnderecoFuncionario = tbEnderecoFuncionario.codEnderecoFuncionario 
				INNER JOIN tbTelefoneFuncionario
				ON tbFuncionario.codFuncionario = tbTelefoneFuncionario.codFuncionario
				WHERE tbFuncionario.codFuncionario = ".$_SESSION['codUsuario'];
            //echo($dados);
                
                 $resultado = $conexao->query($dados);

                while($linharesultado = mysqli_fetch_array($resultado)){
                    $nome = $linharesultado['nomeFuncionario'];
                    $cpf = $linharesultado['cpfFuncionario'];
                    $sexo = $linharesultado['sexoFuncionario'];
                    $nasc = $linharesultado['NascFuncionario'];
                    $salario = $linharesultado['salarioFuncionario'];
                    $email = $linharesultado['emailFuncionario'];
                    $senha = $linharesultado['senhaFuncionario'];
					$telefone = $linharesultado['numeroTelefoneFuncionario'];
                    
                    $rua = $linharesultado['ruaEnderecoFuncionario'];
                    $bairro = $linharesultado['bairroEnderecoFuncionario'];
                    $cep = $linharesultado['cepEnderecoFuncionario'];
                    $numCasa = $linharesultado['numCasaFuncionario'];
                }
            ...
            <div class="enviar">
                <a href="homeFuncionario.php" class="btn btn-primary" id="registerUser">Voltar</a>&nbsp;&nbsp;&nbsp;
