...
try {
    // 1. Busca os dados do funcionário no banco refatorado
    ...
    $sqlTel = "SELECT numero FROM telefone WHERE entidade_tipo = 'responsavel' AND entidade_id = ? LIMIT 1";
...
<html>
    ...
    <body class="fundo" id="fundoCadastro">    
        ...
        <div class="box" style="margin-top: 1em;">
            <form action="../Controller/rotinasAtualizarResponsavel.php" method="post" class="container">
                
                <h3>Edite seus dados:</h3>
                <br>
                
                <input type="hidden" name="id" value="<?php echo $idResponsavel; ?>">

                <div class="form-row">
                    <div class="form-group col-md-3 col-sm-4">
                        <label for="nome">Nome</label>
                        <input type="text" class="form-control" id="nome" name="nome" value="<?php echo htmlspecialchars($resp['nome']); ?>" required placeholder="Nome">
                    </div>
                    <div class="form-group col-md-3 col-sm-4 ">
                        <label for="email">E-mail</label>
                        <input type="email" class="form-control" id="email" name="email" value="<?php echo htmlspecialchars($resp['email']); ?>" required placeholder="E-mail">
                    </div>
                    <div class="form-group col-md-3 col-sm-4">
                    ...
                    <div class="form-group col-md-3 col-sm-4">
                        ...
                        <input type="text" class="form-control" id="cpf" name="cpf" value="<?php echo htmlspecialchars($resp['cpf']); ?>" required placeholder="CPF" onblur="TestaCPF(this.value);">
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-3 col-sm-4">   
                        ...
                        <select class="form-control" id="sexo" name="sexo" required>
                            <option value="Masculino" <?php if($resp['sexo'] == 'Masculino') echo 'selected'; ?>>Masculino</option>
                            <option value="Feminino" <?php if($resp['sexo'] == 'Feminino') echo 'selected'; ?>>Feminino</option>
                        </select>
                    </div>
                    <div class="form-group col-md-3 col-sm-4">
                        <label>Data Nascimento</label>
                        <input type="date" class="form-control" id="nascimento" name="nascimento" value="<?php echo htmlspecialchars($resp['nascimento']); ?>" required>
                    </div>     
                    <div class="form-group col-md-3 col-sm-4">
                        <label>CEP</label>
                        <input type="text" class="form-control" id="cep" name="cep" value="<?php echo htmlspecialchars($resp['cep']); ?>" required placeholder="CEP" onblur="pesquisacep(this.value);">
                    </div>
                    <script type="text/javascript">$("#cep").mask("00000-000");</script>
                    <div class="form-group col-md-3 col-sm-4">
                        <label>Rua</label>
                        <input type="text" class="form-control" id="rua" name="rua" value="<?php echo htmlspecialchars($resp['rua']); ?>" required placeholder="Rua">
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-4 col-sm-5">
                        <label>Bairro</label>
                        <input type="text" class="form-control" id="bairro" name="bairro" value="<?php echo htmlspecialchars($resp['bairro']); ?>" required placeholder="Bairro">
                    </div>
                    <div class="form-group col-md-2 col-sm-3">
                        <label>N° Casa</label>
                        <input type="text" class="form-control" id="numero_casa" name="numero_casa" value="<?php echo htmlspecialchars($resp['numero_casa']); ?>" required placeholder="N°">
                    </div>
                    <div id="divTelefones" class="form-group col-md-4 col-sm-4">
                ...
                <div class="enviar mt-4 mb-5">
                    <a href="homeResponsavel.php" class="btn btn-secondary">Voltar</a>&nbsp;&nbsp;&nbsp;
