...
<head>
    ...
    <title>InfoCare - Cadastro de Gerente</title>
...
<body>
    ...
    <form action="../Controller/processaGerente.php" method="post" class="container">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-2 col-sm-4">
                <input type="date" class="form-control" id="nascimento" name="nascimento" required="" placeholder="Data Nascimento*">
            </div>     
            <div class="form-group col-md-3 col-sm-4">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-3 col-sm-4">
                <input type="number" step="0.01" class="form-control" id="salario" name="salario" required="" placeholder="Salário (Ex: 3500.00)*">
            </div>
