...
// Apenas administradores podem cadastrar gerentes
...
<html lang="pt-br">
<head>
    <title>InfoCare — Cadastrar Gerente</title>
    <meta charset="utf-8">
...
<div class="main-wrapper">
    <header class="topbar">
        <div class="d-flex align-center gap-2">
            ...
            <span class="topbar-title">Cadastrar Gerente</span>
        </div>
    </header>
    ...
    <main class="page-content">
        ...
        <div class="card" style="max-width: 960px; margin: 0 auto;">
            <div class="card-header">
                <span class="card-header-title">Novo Gerente</span>
                ...
                <form method="POST" action="../Controller/processaGerente.php">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="number" step="0.01" name="salario" id="salario" class="form-control" required placeholder="Ex: 3500.00">
                        </div>
                    </div>
