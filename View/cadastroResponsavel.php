...
<head>
    ...
    <title>InfoCare - Cadastro de Responsável</title>
...
<body>
    ...
    <form action="../Controller/processaRes.php" method="post" class="container">
        ...
        <div class="enviar mt-3 mb-5">
            <a href="listarRes.php" class="btn btn-secondary">Voltar</a>&nbsp;&nbsp;&nbsp;
