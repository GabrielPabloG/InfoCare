...
// Lista de idosos com o nome do responsável (único JOIN necessário)
$sqlIdosos = "
    SELECT
        i.id,
        i.nome,
...
<aside class="sidebar" id="sidebar">
    ...
    <div class="sidebar-footer">
        <a href="../View/logout.php" class="sidebar-link"><i class="icon">↩</i> Sair</a>
    </div>
</aside>
    ...
    <main class="page-content">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <a href="cadastroIdosoTab.php" class="btn btn-primary btn-sm">+ Novo Idoso</a>
            </div>
...
<div class="modal fade" id="modalEditar" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="../Controller/rotinasAtualizarIdoso.php">
