...
// Foto de perfil do responsável logado
$imgPerfil = $_SESSION['foto_perfil'] ?? '../upload/user.png';

// Busca apenas os dados básicos do idoso + nome do responsável + foto
$sqlIdosos = "
    SELECT
        i.id,
        i.nome,
...
<html lang="pt-br">
<head>
    <title>InfoCare — Painel do Responsável</title>
    <meta charset="utf-8">
    ...
    <main class="page-content">
        ...
        <div class="card">
            ...
            <div class="table-wrapper">
                <table class="table">
                    <thead>
                        <tr><th>Código</th><th>Nome</th><th>CPF</th><th></th></tr>
                    </thead>
                    <tbody>
                        <?php if (empty($resultado_idoso)): ?>
                            <tr><td colspan="4" class="text-center text-muted py-4">Nenhum idoso vinculado.</td></tr>
                        <?php else: ?>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <?php 
                                                $fotoIdoso = !empty($idoso['foto']) ? '../upload/' . htmlspecialchars($idoso['foto']) : '../upload/user.png';
                                                ?>
                                                <div class="text-center mb-3">
                                                    <img src="<?= $fotoIdoso ?>" alt="Foto" style="max-width:150px; border-radius:8px;">
                                                </div>
                                                ...
                                                <p><strong>Responsável:</strong> <?= htmlspecialchars($idoso['responsavel'] ?? 'Não vinculado') ?></p>
                                            </div>
